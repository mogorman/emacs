...
(setq lsp-elixir-server-command '("/home/mog/code/pepsico/elixir-ls/release/language_server.sh"))

;; (defvar lsp-elixir--config-options (make-hash-table))
;; (puthash "dialyzerEnabled" :json-true lsp-elixir--config-options)
;; (puthash "fetchDeps" :json-true lsp-elixir--config-options)
;; ;;(puthash "projectDir" "platform/" lsp-elixir--config-options)
